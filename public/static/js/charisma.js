var host = 'http://static.quanlygame.dev/';
$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', host + 'bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', host + 'css/bootstrap-' + themeName + '.min.css');
        }
